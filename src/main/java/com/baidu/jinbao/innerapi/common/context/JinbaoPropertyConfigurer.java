...
/**
 * Jinbao PropertyConfigurer
 * 
 * @author cgd
 * @date 2015年5月31日 上午10:18:51
 */
public class JinbaoPropertyConfigurer extends PropertyPlaceholderConfigurer {
    ...
    /**
     * 替换，类似: DpopPropertyConfigurer.replacePlaceholders("${name}");
     * 
     * @param key
     * @param defaultValue
     * @return
    ...
    static class DpopPropertyPlaceholderHelper extends PropertyPlaceholderHelper {
        ...
        public DpopPropertyPlaceholderHelper(String placeholderPrefix, String placeholderSuffix, String valueSeparator,
