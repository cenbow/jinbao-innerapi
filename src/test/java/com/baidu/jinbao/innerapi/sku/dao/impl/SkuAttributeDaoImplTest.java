...
/**
 * SkuAttributeDaoImplTest
 * 
 * @author cgd
 * @date 2015年6月12日 上午10:45:37
 */
public class SkuAttributeDaoImplTest extends AbstractDAOTests {
    @Resource
    private SkuAttributeDao skuAttributeDao;

    @Before
    public void setUp() {
        this.executeDatas("sku/sku_attribute_init.sql");
    }
    ...
    public void testbatchInsert() {
        ...
        this.skuAttributeDao.batchInsert(0, skuAttributeList);
    ...
    public void testbatchUpdate() {
        ...
        this.skuAttributeDao.batchUpdate(0, skuAttributeList);
    ...
    public void testbatchSelect() {
        ...
        this.skuAttributeDao.batchSelect(0, skuQueryCondition);
        Assert.assertTrue(true);
    }
    ...
    public void testbatchDeletes() {
        ...
        skuQueryCondition.setSkuInnerIdList(skuInnerIdList);
        skuQueryCondition.setSkuIdList(skuIdList);
        this.skuAttributeDao.batchDelete(0, skuQueryCondition);
        Assert.assertTrue(true);
    }
    ...
    public void testUpdateBySkuId() {
        ...
        this.skuAttributeDao.updateBySkuId(0, item);
